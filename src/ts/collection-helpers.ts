...
import type { Book, ToggleResult } from "./types.js";

export const loadCollection = (): Set<string> => {
  try {
...
export const saveCollection = (collectionSet: Set<string>): void => {
...
export const toggleBookInCollection = (bookTitle: string): ToggleResult => {
...
export const loadCustomBooks = (): Book[] => {
  try {
...
export const saveCustomBooks = (customBooks: Book[]): void => {
